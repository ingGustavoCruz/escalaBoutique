<?php
/**
 * admin/productos/index.php - Listado de Inventario
 */
session_start();
...
// Lógica de Eliminación Rápida (Simple)
...
<head>
    <meta charset="UTF-8">
    <title>Productos | Escala Admin</title>
...
<body class="bg-slate-50 font-sans flex h-screen overflow-hidden">
    ...
    <aside class="w-64 bg-escala-dark text-escala-beige flex flex-col flex-shrink-0 shadow-2xl z-20">
        ...
        <nav class="flex-1 overflow-y-auto py-6 px-4 space-y-2">
            ...
            <a href="index.php" class="flex items-center gap-3 px-4 py-3 bg-white/10 text-white rounded-xl shadow-inner transition-all">
                <i data-lucide="package" class="w-5 h-5"></i> <span class="font-bold text-sm">Productos</span>
            </a>
    ...
    <main class="flex-1 flex flex-col h-screen overflow-hidden">
        <header class="h-16 bg-white shadow-sm flex items-center justify-between px-8 border-b border-gray-100 z-10">
            <h1 class="text-xl font-black text-escala-green uppercase tracking-wide">Inventario General</h1>
            
            <a href="crear.php" class="bg-escala-green hover:bg-escala-dark text-white px-5 py-2.5 rounded-lg text-sm font-bold uppercase shadow-lg transition-all flex items-center gap-2 transform hover:-translate-y-0.5">
