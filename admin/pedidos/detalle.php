<?php
/**
 * admin/pedidos/detalle.php - Gestión Individual
 */
session_start();
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['nuevo_estado'])) {
    ...
    // Aquí podrías agregar lógica para devolver stock si se cancela, etc.
...
$queryHead = "
    SELECT p.*, e.nombre, e.numero_empleado, e.email, e.area 
    FROM pedidos p 
            ...
            <div class="md:col-span-2 space-y-6">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden">
                    <div class="p-5 bg-gray-50 border-b border-gray-100">
                        <h2 class="font-bold text-gray-700 uppercase text-sm flex items-center gap-2">
                            <i data-lucide="package" class="w-4 h-4"></i> Productos Solicitados
                        </h2>
                    </div>
                    <div class="divide-y divide-gray-100">
                        ...
                        <div class="p-5 flex items-center gap-4 hover:bg-gray-50 transition-colors">
                            ...
                            <div class="flex-1">
                                ...
                                <?php if($item['talla']): ?>
                                    <span class="text-[10px] bg-gray-200 text-gray-600 px-2 py-0.5 rounded font-bold uppercase">Talla: <?php echo $item['talla']; ?></span>
                                <?php endif; ?>
                            </div>
            ...
            <div class="space-y-6">
                <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        <div class="w-12 h-12 bg-escala-beige/20 rounded-full flex items-center justify-center text-escala-dark">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between text-sm border-b border-gray-50 pb-2">
                            <span class="text-gray-500">No. Empleado:</span>
                            <span class="font-bold text-gray-800"><?php echo $pedido['numero_empleado']; ?></span>
                        </div>
                        <div class="flex justify-between text-sm border-b border-gray-50 pb-2">
                            <span class="text-gray-500">Área:</span>
                            <span class="font-bold text-gray-800"><?php echo $pedido['area']; ?></span>
                        </div>
                        <div class="flex justify-between text-sm pt-2">
                            <span class="text-gray-500">Plazos Nómina:</span>
                            <span class="font-black text-escala-green bg-escala-green/10 px-2 rounded"><?php echo $pedido['plazos']; ?> Qnas</span>
                        </div>
                    </div>
                </div>
