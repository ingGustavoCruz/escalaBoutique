...
<body class="bg-slate-50 font-sans" x-data="{ sidebarOpen: false, showModal: false, couponForImage: null }">
                    ...
                    <div class="xl:col-span-1">
                        <div class="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 sticky top-0">
                            ...
                            <form method="POST" class="space-y-5">
                                ...
                                <div>
                                    <label class="block text-[10px] font-bold text-gray-400 uppercase tracking-widest mb-1">Código</label>
